...
return [
    ...
    'viz' => [
        ...
        'engine_toggle' => 'Map rendering',
        'engine_leaflet_title' => 'Classic map (Leaflet, raster tiles)',
        'engine_maplibre_title' => 'Advanced GPU map (MapLibre GL + deck.gl, vector tiles)',
        'engine_fallback' => 'Your browser does not support WebGL; using the classic map (Leaflet).',
        'mode_filter' => 'Mode:',
